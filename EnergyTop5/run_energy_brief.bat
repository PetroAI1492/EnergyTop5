@echo off
REM --------------------------------------------------
REM ENERGY TOP 5 - Automated Run
REM --------------------------------------------------

set REPO_DIR=C:\mygit\EnergyTop5
...
REM --------------------------------------------------
REM Run the ENERGY TOP 5 generator
REM --------------------------------------------------
if %FAILED%==0 (
...
if %FAILED%==0 (
    ...
    if errorlevel 1 (
        git commit -m "Automated ENERGY TOP 5 update" >> "%LOG_FILE%" 2>&1
    ) else (
...
if %FAILED%==1 (
    powershell -Command ^
      "[System.Reflection.Assembly]::LoadWithPartialName('System.Windows.Forms') | Out-Null; ^
       [System.Windows.Forms.MessageBox]::Show('ENERGY TOP 5 FAILED. Check run_energy_brief.log','Energy Brief Failure')"
)
